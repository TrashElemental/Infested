...
import net.mcreator.infested.procedures.AttackSilverfishOnInitialEntitySpawnProcedure;
import net.mcreator.infested.init.InfestedModEntities;

import javax.annotation.Nullable;

public class AttackSilverfishEntity extends Animal {
	public AttackSilverfishEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InfestedModEntities.ATTACK_SILVERFISH.get(), world);
	}

	public AttackSilverfishEntity(EntityType<AttackSilverfishEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		AttackSilverfishOnInitialEntitySpawnProcedure.execute(world, this);
		return retval;
	}

	@Override
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		AttackSilverfishEntity retval = InfestedModEntities.ATTACK_SILVERFISH.get().create(serverWorld);
