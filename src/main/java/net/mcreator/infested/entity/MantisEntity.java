...
public class MantisEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(MantisEntity.class, EntityDataSerializers.BOOLEAN);
	...
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(MantisEntity.class, EntityDataSerializers.STRING);
	...
	public MantisEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InfestedModEntities.MANTIS.get(), world);
	}

	public MantisEntity(EntityType<MantisEntity> type, Level world) {
		super(type, world);
		xpReward = 3;
		setNoAi(false);
		setMaxUpStep(0.6f);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "mantis");
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new FollowOwnerGoal(this, 1, (float) 10, (float) 2, false) {
			...
			public boolean canUse() {
				double x = MantisEntity.this.getX();
				double y = MantisEntity.this.getY();
				double z = MantisEntity.this.getZ();
				Entity entity = MantisEntity.this;
				Level world = MantisEntity.this.level();
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		MantisEntity retval = InfestedModEntities.MANTIS.get().create(serverWorld);
	...
	public static void init() {
		SpawnPlacements.register(InfestedModEntities.MANTIS.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(MantisEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
