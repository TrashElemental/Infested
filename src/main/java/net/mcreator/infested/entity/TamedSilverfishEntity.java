...
import net.mcreator.infested.procedures.TamedSilverfishOnInitialEntitySpawnProcedure;
import net.mcreator.infested.init.InfestedModEntities;

import javax.annotation.Nullable;

public class TamedSilverfishEntity extends TamableAnimal {
	public TamedSilverfishEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InfestedModEntities.TAMED_SILVERFISH.get(), world);
	}

	public TamedSilverfishEntity(EntityType<TamedSilverfishEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		TamedSilverfishOnInitialEntitySpawnProcedure.execute(world, this);
		return retval;
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		TamedSilverfishEntity retval = InfestedModEntities.TAMED_SILVERFISH.get().create(serverWorld);
