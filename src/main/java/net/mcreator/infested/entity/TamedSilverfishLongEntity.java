...
import net.mcreator.infested.procedures.TamedSilverfishLongOnInitialEntitySpawnProcedure;
import net.mcreator.infested.init.InfestedModEntities;

import javax.annotation.Nullable;

public class TamedSilverfishLongEntity extends TamableAnimal {
	public TamedSilverfishLongEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(InfestedModEntities.TAMED_SILVERFISH_LONG.get(), world);
	}

	public TamedSilverfishLongEntity(EntityType<TamedSilverfishLongEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		TamedSilverfishLongOnInitialEntitySpawnProcedure.execute(world, this);
		return retval;
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		TamedSilverfishLongEntity retval = InfestedModEntities.TAMED_SILVERFISH_LONG.get().create(serverWorld);
