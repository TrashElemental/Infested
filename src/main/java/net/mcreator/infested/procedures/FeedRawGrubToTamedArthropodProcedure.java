...
public class FeedRawGrubToTamedArthropodProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == InfestedModItems.RAW_GRUB.get() && entity instanceof LivingEntity _livEnt2 && _livEnt2.getMobType() == MobType.ARTHROPOD
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.HAPPY_VILLAGER, (entity.getX()), (entity.getY()), (entity.getZ()), 10, 1, 2, 1, 0);
