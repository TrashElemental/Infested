...
public class SpiderArmorGetCobwebProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if ((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.LEGS) : ItemStack.EMPTY).getItem() == InfestedModItems.SPIDER_ARMOR_LEGGINGS.get()
				...
				&& (entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.HEAD) : ItemStack.EMPTY).getItem() == InfestedModItems.SPIDER_ARMOR_HELMET.get() && entity.isShiftKeyDown()) {
			SpiderArmorGiveCobwebProcedure.execute(world, entity);
		}
	}
}
