...
public class ResistancePotionRecipeBrewingRecipe implements IBrewingRecipe {
	...
	public static void init(FMLCommonSetupEvent event) {
		event.enqueueWork(() -> BrewingRecipeRegistry.addRecipe(new ResistancePotionRecipeBrewingRecipe()));
	}
	...
	public ItemStack getOutput(ItemStack input, ItemStack ingredient) {
		if (isInput(input) && isIngredient(ingredient)) {
			return PotionUtils.setPotion(new ItemStack(input.getItem()), InfestedModPotions.RESISTANCE_POTION.get());
		}
